        ...
        <div class="bg-white rounded-2xl border border-ink/10 shadow-xl shadow-ink/5 p-8">
            ...
            <div class="prose prose-sm prose-slate text-ink/70">
                ...
                <ul class="list-none pl-0 space-y-2 mb-4">
                    <li>a. You must be at least 13 years old to use our website or make purchases.</li>
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Product Information and Pricing</h2>
                <ul class="list-none pl-0 space-y-2 mb-4">
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Orders and Payments</h2>
                <ul class="list-none pl-0 space-y-2 mb-4">
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Shipping and Delivery</h2>
                <ul class="list-none pl-0 space-y-2 mb-4">
                    <li>a. We will make reasonable efforts to ensure timely shipping and delivery of your orders (if applicable).</li>
                    <li>b. Shipping and delivery times provided are estimates and may vary based on your location and other factors.</li>
                </ul>

                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Returns and Refunds</h2>
                <ul class="list-none pl-0 space-y-2 mb-4">
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Amendments and Termination</h2>
