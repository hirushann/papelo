...
<header class="sticky top-0 z-50 bg-paper/95 backdrop-blur-sm border-b border-ink/10">
  <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
    ...
    <nav class="hidden md:flex items-center gap-8 text-sm font-medium text-ink/80">
      ...
      <a href="{{ route('about') }}" class="text-teal">About</a>
    </nav>
...
<section class="bg-examsheet-quiet">
  <div class="max-w-4xl mx-auto px-6 py-16">
    <h2 class="font-display text-2xl text-ink mb-10 text-center">What we believe</h2>
    <div class="grid sm:grid-cols-3 gap-8">
      <div>
        <div class="w-10 h-10 rounded-full bg-teal/10 flex items-center justify-center mb-4">
          <svg class="w-5 h-5 text-teal" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg>
        </div>
        <h3 class="font-display text-lg text-ink mb-2">Instant beats eventual</h3>
        <p class="text-sm text-ink/60 leading-relaxed">Feedback a week later teaches you almost nothing. Feedback in the same minute changes how you study.</p>
      </div>
      <div>
        <div class="w-10 h-10 rounded-full bg-teal/10 flex items-center justify-center mb-4">
          <svg class="w-5 h-5 text-teal" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 3v18h18"/><path d="M7 14l4-4 4 4 5-5"/></svg>
        </div>
        <h3 class="font-display text-lg text-ink mb-2">Know exactly what's weak</h3>
        <p class="text-sm text-ink/60 leading-relaxed">"Study harder" isn't useful advice. "Chemical Reactions is your weakest topic" is.</p>
      </div>
      <div>
        <div class="w-10 h-10 rounded-full bg-teal/10 flex items-center justify-center mb-4">
          <svg class="w-5 h-5 text-teal" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
        </div>
        <h3 class="font-display text-lg text-ink mb-2">Practice shouldn't cost more than tuition</h3>
        <p class="text-sm text-ink/60 leading-relaxed">A single paper should cost less than a bus fare to a tuition class, not more.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="bg-ink">
  <div class="max-w-3xl mx-auto px-6 py-16 text-center">
    <h2 class="font-display text-2xl sm:text-3xl text-paper mb-6">Try it on your next past paper.</h2>
