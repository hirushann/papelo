    ...
    <div class="max-w-3xl mx-auto px-6 py-12">
        <div class="bg-white rounded-2xl border border-ink/10 shadow-xl shadow-ink/5 p-8">
            ...
            <div class="prose prose-sm prose-slate text-ink/70">
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Refunds</h2>
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Exchanges</h2>
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Non-Returnable Items</h2>
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Damaged or Defective Items</h2>
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Return Shipping</h2>
                ...
                <h2 class="text-lg font-semibold text-ink mt-8 mb-3">Processing Time</h2>
