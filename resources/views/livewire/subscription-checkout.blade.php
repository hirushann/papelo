  ...
  <div class="bg-examsheet-quiet text-ink antialiased min-h-screen">
    ...
    <main class="max-w-4xl mx-auto px-6 py-8">
      ...
      <div class="rounded-xl border border-ink/10 bg-white p-5 text-center">
        ...
        <p class="text-xs text-ink/50 mb-3">You'll be taken to a secure payment page. Papelooo never sees or stores your card details.</p>
      ...
      <p class="text-center text-xs text-ink/40 mt-4">By subscribing, you agree to Papelooo's <a href="{{ route('terms') }}" class="underline">Terms</a> and <a href="{{ route('refund') }}" class="underline">Refund Policy</a>.</p>
