                ...
                <div class="bg-white rounded-xl border border-ink/10 p-5 flex flex-col hover:border-teal/40 hover:shadow-md hover:shadow-ink/5 transition">
                  ...
                  <div class="mt-auto flex items-center justify-between">
                    @if($this->isPurchased($paper))
                      <span class="text-xs font-semibold text-teal">Purchased</span>
                    ...
                    @else
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('paper.buy', $paper->id) }}" wire:navigate class="text-xs font-semibold text-teal hover:underline">Buy →</a>
                      </div>
                    @endif
                  </div>
                </div>
