        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route(auth()->user()?->is_admin ? 'dashboard' : 'papers') }}" wire:navigate>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                <a href="{{ route('login') }}" wire:navigate class="text-sm font-medium text-ink/70 hover:text-ink">Log in</a>
                <a href="{{ route('register') }}" wire:navigate class="text-sm font-semibold bg-teal text-white px-4 py-2 rounded-lg hover:bg-teal/90 transition">Sign up</a>
            </div>
            @endauth
