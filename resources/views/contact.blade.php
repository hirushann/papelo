...
<style>
  .field label { display:block; font-size:0.8rem; font-weight:600; color:rgba(34,49,74,0.75); margin-bottom:0.4rem; }
  .field input, .field select, .field textarea {
    width:100%; border:1px solid rgba(34,49,74,0.15); border-radius:0.5rem; padding:0.65rem 0.9rem;
    font-size:0.9rem; color:#22314A; background:#fff;
  }
  .field input:focus, .field select:focus, .field textarea:focus { outline:none; border-color:#3F7D6B; box-shadow:0 0 0 3px rgba(63,125,107,0.15); }
</style>
</head>
<body class="bg-examsheet-quiet text-ink antialiased min-h-screen">
...
<main class="max-w-5xl mx-auto px-6 py-16">
  <div class="text-center mb-14">
    <h1 class="font-display text-4xl text-ink mb-3">Get in touch</h1>
    <p class="text-ink/60 max-w-md mx-auto">Questions about a paper, a payment, or your account — we usually reply within 24 hours.</p>
  </div>

  <div class="grid md:grid-cols-[1fr_320px] gap-10">

    <!-- FORM -->
    <div class="bg-white rounded-2xl border border-ink/10 p-7">
    ...
    <div class="space-y-5">
      <div class="bg-white rounded-2xl border border-ink/10 p-5">
        <p class="text-xs font-semibold uppercase tracking-wide text-ink/40 mb-3">Email us directly</p>
        <a href="mailto:support@papelo.lk" class="text-teal font-semibold hover:underline">support@papelo.lk</a>
      </div>
      <div class="bg-white rounded-2xl border border-ink/10 p-5">
        <p class="text-xs font-semibold uppercase tracking-wide text-ink/40 mb-3">Payment or billing?</p>
        <p class="text-sm text-ink/60">Check your <a href="{{ route('dashboard') }}" class="text-teal hover:underline">billing history</a> first — most payment questions can be answered there instantly.</p>
      </div>
      <div class="bg-white rounded-2xl border border-ink/10 p-5">
        <p class="text-xs font-semibold uppercase tracking-wide text-ink/40 mb-3">Response time</p>
        <p class="text-sm text-ink/60">We're a small team — usually within 24 hours, faster on weekdays.</p>
      </div>
    </div>
  </div>
</main>
